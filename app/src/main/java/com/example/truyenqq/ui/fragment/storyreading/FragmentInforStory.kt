package com.example.truyenqq.ui.fragment.storyreading
...
import com.example.truyenqq.ui.activities.story.ViewModelStory
...
class FragmentInforStory : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        viewModel.Story.observe(this@FragmentInforStory, androidx.lifecycle.Observer {
            ...
            tvStoryDate.text =
                "Cập nhật: " + "${cal.get(Calendar.DAY_OF_MONTH)}/${cal.get(Calendar.MONTH) + 1}/${cal.get(
                    Calendar.YEAR)}"
